...
public class DraggableThing extends VisibleThing {
    private boolean mouseWasPressed; // tracks whether the mouse was pressed during the last
                                     // update()
    ...
    public Action update() {
        ...
        } // sets isDragging to false and drops the item if the mouse has been released
        mouseWasPressed = getProcessing().mousePressed; // updates the mouseWasPressed
