...
public class Nat extends PApplet {
  ...
  private ArrayList<Transport> transports; // holds all transportsation methods
  private Transport transport;

  @Override
  public void settings() {
    super.settings();
    mapImage = new PImage(loadImage("./src/images/nat.png").get().getImage().getScaledInstance(800,
